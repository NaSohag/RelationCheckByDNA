...
public class Paterinty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.paternity);
                ...
                if(flag==0) {
                    for (int i = 1; i <= n; i++) {
                        ...
                        if (child.equals(lcs(child, lcs(s1, s2)))) {
                            flag = 1;
                            tv1.setText("Father is Man_" + i);
                            break;
                        }
                    }
                }
                if(flag==0)tv1.setText("Father is missing here");
